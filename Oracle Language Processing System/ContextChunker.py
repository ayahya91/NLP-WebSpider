...
def main():
	...
	print("\nTime elapsed in sec. for training: " + str(time.time() - start_time))
	print("\nTesting...")
	print("\nTesting Length: " + str(len(test_sents)))
	start_time = time.time()
	print(context_chunker.evaluate(test_sents))
	print("\nTime elapsed in sec. for testing: " + str(time.time() - start_time))
	print("\nSaving Trigram Chunker")
	serialize_object(context_chunker, 'chunk', 'context_chunker.pkl')
	print("\nContext chunker successfully saved")
